        ...
        <Card className="card-post" ref={cardPostRef}>
          <Card className="card-post-1">
            <Col className="text-center">
              <Button
                ...
                onClick={() =>
                  upVote(post.post.total_vote_up, post.post.total_vote_down)
                }
              >
          ...
          <Card className="card-post-2">
            <Col className="text-center">
              <Button
                variant={
                  post.post.bookmark_status === true ? "card-post" : "none"
                }
                onClick={() =>
                  statusBookmark(post.post.id_post, post.post.bookmark_status)
                }
              >
            ...
            <Col className="text-center">
              <Button variant="none" onClick={showComment}>
        ...
        <div className="post" ref={postRef}>
          ...
          <Row>
            <Col xl={6} lg={6} md={6} sm={6}>
              ...
              >
                ...
                <Card.Body style={{ padding: "0", margin: "10px" }}>
                  ...
                  {post.post.access === 1 && post.post.status === 1 ? (
                    <Card.Text className="d-flex btn-post-watch-left">
                      <Button variant="none">
                        <i className="fas fa-star">&nbsp;{mark.mark}</i>
                      </Button>
                      <Button variant="none">
                    ...
                    <Card.Text className="d-flex btn-post-watch-left">
                      ...
                      {post.author.id_account === user.id_account ? (
                        <>
                          <Button variant="none">
                            {post.post.access === 0 ? (
                              <i
                                className="far fa-check-circle"
                                onClick={() => changeAccess(post.post.access)}
                              ></i>
                            ) : (
                              <i
                          ...
                          <Button
                            variant="none"
                            onClick={() =>
                              dispatch(changeAccess2(post.post.id_post))
                            }
                          >
            ...
            <Col xl={6} lg={6} md={6} sm={6}>
              ...
              >
                <Card.Body
                  style={{ padding: "0", margin: "10px", alignItems: "center" }}
                >
                  ...
                  <Card.Text
                    className="btn-post-watch-right"
